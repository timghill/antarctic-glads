...
def run_scenarios(basin, year):
    ...
    C_poc = C_glads * np.sqrt( (Nfields['glads_present'] / Nfields['poc_present'])**(1./5.) ) 
    C_RF = C_glads * np.sqrt( (Nfields['glads_present'] / Nfields['rf_present'] )**(1./5.) )
