...
def main():
    ...
    N_glads_future[levelset>0] = np.load('../../../analysis/parameters_full/data/pred_B-C_2300_N_glads.npy')/1e6
    N_glads_present =  np.zeros((len(levelset), 100))
    present_levelset = np.load('../../B-C/data/geom/ocean_levelset.npy')
    N_glads_present[present_levelset>0] = np.load('../../../analysis/parameters_full/data/pred_B-C_N_glads.npy')/1e6
