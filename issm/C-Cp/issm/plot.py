...
B = np.load('rheology_B.npy').squeeze()
print('B:', np.median(B))
fig,ax = plt.subplots()
tpc = ax.tripcolor(mtri, np.log10(B), cmap=cmocean.cm.speed, vmin=6, vmax=10)
ax.set_aspect('equal')
ax.set_title('Rheology B')
fig.colorbar(tpc)
fig.savefig('rheologyB.png', dpi=400)
