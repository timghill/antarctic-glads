...
def main(basins, features):
    # if not os.path.exists('r.pkl'):
    #     print('FITTING MODEL')
    #     fit_model(basins, features)
    model = np.load('rf.pkl', allow_pickle=True)
...
if __name__=='__main__':
    ...
    feature_labels = [
        ...
        'Surface slope',
        'Bed slope',
        'Shreve potential slope',
    ]
    main(basins[:2], features)